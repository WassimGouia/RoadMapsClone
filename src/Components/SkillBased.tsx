    ...
    return (
        <div>
          <div className='relative grid place-items-center'>
            ...
            <h1 className="text-md text-center text-slate-400 z-10 bg-slate-900 border border-slate-900 font-regular text-md rounded-lg inline-flex top-[17px] px-3 py-1">Skill Based RoadMaps </h1>
          </div>
          <Container>
