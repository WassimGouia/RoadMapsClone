    ...
    return (
        <div className="flex justify-between items-center space-x-4 background text-white">
            <div className="mr-auto">
                ...
                <button className="font-sans hover:Segoe UI font-semibold inline-block text-[#7295A9]"> Roadmaps </button>
                <button className="font-sans hover:Segoe UI font-semibold inline-block text-[#7295A9]"> Guides </button>
                <button className="font-sans hover:Segoe UI font-semibold inline-block text-[#7295A9]"> videos </button>
